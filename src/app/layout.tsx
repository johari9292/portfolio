        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Katpana Desert",
              "description": "Katpana Desert is a unique cold desert in Skardu, Pakistan, situated at an altitude of 2,226 meters above sea level. It is one of the highest deserts in the world, featuring pristine white sand dunes surrounded by snow-capped mountains.",
              "image": [
              ...
              "touristType": ["Nature Lovers", "Photography Enthusiasts", "Adventure Seekers"],
              "amenityFeature": [
                {
